...
class AppColors {
  ...
  static const Color primaryColor = Color(0xffFF785A);
  ...
  static const Color textFieldBorderColor = Color(0xffC5C5C5);

  static const Color bgColor = Color(0xFF2A2B2D);
  ...
  static const Color navbuttonColor = Color(0xffF9F8F8);
  static const Color floatingButtonActiveColor = Color(0xffA6A5B2);
  static const Color lightRedColor = Color(0xffFFB7B7);
  static const Color lightGreenColor = Color(0xff9EDAC2);
